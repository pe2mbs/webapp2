import { Component, EventEmitter, Input, ChangeDetectionStrategy, Output,  OnInit, SimpleChanges, OnChanges, AfterViewInit } from '@angular/core';
	...
	public ngAfterViewInit(): void {
		if (this.filterRecord) {
			try {
				...
				const value = this.filterRecord.findItem(this.field).value;
