...
#
*/
import { Input, OnChanges, OnInit, AfterViewInit, Output, EventEmitter, Component, TemplateRef } from '@angular/core';
...
@Component({
    ...
    <app-edit-table-button 
     [id]="formControlName" [value]="serviceItem"
...
export class GcBaseComponent extends GcSubscribers implements ControlValueAccessor, OnChanges, OnInit, AfterViewInit
{
    ...
    // position of the button that opens the corresponding screen for the input
    @Input()                buttonPosition: string = 'none';
    @Input()                serviceName: string;
    @Input()                serviceItem: any;
    @Input()                icon: string;
    @Input()                funcToEvaluate: string;
    @Input()                contextObject: any;
    @Input()                onSaveClick: Subject<boolean>;
    @Input()                color;
    @Input()                hint;
    ...
    ngAfterViewInit()
    {
        ...
        if (this.control) this.control.valueChanges.subscribe( () => this.onControlChange() );
    }
    ...
    onControlChange()
    {
        ...
        if ( this.debug )
        {
            console.log( "onControlChange -> emit", this.control.value  );
        }
