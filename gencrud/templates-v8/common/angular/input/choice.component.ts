...
@Component( {
    ...
    [serviceItem]="control ? control.value : ''" [buttonPosition]="buttonPosition" [icon]="icon" [funcToEvaluate]="funcToEvaluate"
    [contextObject]="contextObject" [disableEdit]="disableEdit">
    <ng-template #ref>
    <div class="form">
